    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div
          ...
          tabIndex={0}
          className="flex  min-w-[200px] min-h-10 cursor-pointer items-start justify-start gap-2 rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
        ...
        >
          ...
          {/* Control buttons */}
          <span className="z-10 ml-auto flex items-start gap-2">
            {value.length > 0 && (
              <button
                type="button"
